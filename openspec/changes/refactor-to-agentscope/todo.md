...
事件 / SSE 全覆盖                 ███████░░░  ~70%  公共 event_stream；permission/DataDelta
...
| `app/services/ai/runtime/agentscope/event_stream.py` | General/ChatBI 共享事件映射（permission、DataDelta、external） |
