...
"""
    ...
    GLOBAL_GUARDRAILS = (
        ...
        "不要逐行粘贴全部明细；完整明细由前端「查询结果明细」表格提供。\n"
...
class KnowledgeChatPrompts:
    ...
    TURN_SYSTEM_HINT = (
        ...
        "禁止调用 web_search_baidu_http、web_search_bing_http、web_search_baidu、fetch_static_web_url 等外网检索工具；"
    ...
    SEARCH_CORRECTION_MSG = (
        ...
        "禁止调用 web_search_baidu_http、web_search_bing_http、web_search_baidu 等外网工具；"
    ...
    PREFETCH_DONE_CORRECTION_MSG = (
        ...
        "且禁止调用 web_search_baidu_http、web_search_bing_http、web_search_baidu 等外网检索工具。"
