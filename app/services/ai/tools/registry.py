...
class ToolRegistry:
    ...
    _registry: Dict[str, Any] = {
        ...
        "browser_read_visible": browser_read_visible,
        "browser_hover": browser_hover,
        "browser_drag": browser_drag,
        "browser_slider_drag": browser_slider_drag,
        ...
        "browser_export_pdf": browser_export_pdf,
        ...
        "browser_check_auth": browser_check_auth,
        "browser_get_network_logs": browser_get_network_logs,
        "browser_get_cookies": browser_get_cookies,
        "browser_set_cookies": browser_set_cookies,
