          ...
          >
            ...
            >
              ...
              <DatasetCapabilityMenu
                ...
                :mountable-datasets="mountableDatasets"
                :active-metadata-dataset-ids="activeMetadataDatasetIds"
                :session-mounted-dataset-ids="sessionMountedDatasetIds"
                ...
                @toggle-metadata-dataset="(id) => emit('toggle-metadata-dataset', id)"
                @pin-metadata-dataset="(id) => emit('pin-metadata-dataset', id)"
                @unpin-metadata-dataset="(id) => emit('unpin-metadata-dataset', id)"
                @execute-saved-report="(p) => emit('execute-saved-report', p)"
                @edit-saved-report="(p) => emit('edit-saved-report', p)"
              />
            </div>
          </div>
        </transition>
